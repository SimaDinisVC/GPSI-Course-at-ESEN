...
<body class="min-vh-100">
    <nav class="navbar navbar-expand-lg navbar-dark pt-3" aria-label="Thirteenth navbar example">
        <div class="container">
            <a class="navbar-brand me-0 text-light" href=".">QueuePro</a>
    ...
    <div class="container col-xl-10 px-4">
        <div class="row align-items-center g-lg-5">
            <div class="col-lg-7 text-center text-lg-start">
                <h1 class="display-4 fw-bold lh-1 text-body-emphasis mb-3">Solução para gerir filas de espera está aqui.</h1>
