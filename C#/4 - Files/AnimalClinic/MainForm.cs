    ...
    public partial class MainForm : Form
    {
        ...
        private void tgbTema_CheckedChanged(object sender, EventArgs e) // Mudança de Tema
        {
            if (tgbTema.Checked)
            {
                ...
                if (tgbIcons.CheckState.ToString() == "Unchecked")
                {
                    ...
                    btnAdmin.Image = Properties.Resources.admin_black;
                }
            }
            else
            {
                ...
                if (!tgbIcons.Checked)
                {
                    ...
                    btnAdmin.Image = Properties.Resources.admin_white;
                }
            }
            ...
            foreach (Form frm in Forms) // Passa informação aos Forms Filhos de que o Tema foi alterado
            {
                ...
                else if (frm is forms.frmRececionistas && frm.Visible == true)
                    ((forms.frmRececionistas)frm).LoadTema();
                else if (frm is forms.frmAdmin && frm.Visible == true)
                    ((forms.frmAdmin)frm).LoadTema();
            }
        }
        ...
        private void tgbIcons_CheckedChanged(object sender, EventArgs e) // Mudança de Icons de Cor
        {
            ...
            if (tgbIcons.Checked)
            {
                ...
                btnAdmin.Image = Properties.Resources.admin_color;
            }
            else
            {
                if (tgbTema.Checked)
            ...
            foreach (Form frm in Forms) // Passa informação aos Forms Filhos de que os Icons foram alterados
            {
                ...
                //((forms.frmMedicos)frm).LoadTema();
                if (frm is forms.frmRececionistas && frm.Visible == true)
                    ((forms.frmRececionistas)frm).LoadIcons();
            }
        }

        private void MainForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            Clinica.UpdateAllFiles();
        }
    }
}
