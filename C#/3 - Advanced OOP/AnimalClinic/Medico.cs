...
namespace AnimalClinic
{
    public class Medico : Pessoa
    {
        ...
        private void MeuManipuladorDeEventos(object sender, EventArgs e) // Para quando é removido um funcionário que tem as mesmas espcialiadades que as do objeto em causa
        {
