...
<body class="min-vh-100">
    <nav class="navbar navbar-expand-lg navbar-dark pt-3" aria-label="Thirteenth navbar example">
        <div class="container">
            <a class="navbar-brand me-0 text-dark" href="../Home/">QueuePro</a>
            ...
            <div class="collapse navbar-collapse d-lg-flex" id="navbarsExample11">
                ...
                <ul class="navbar-nav col-lg-6 justify-content-lg-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-dark" aria-current="page" href="./">Why QueuePro</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" aria-current="page" href="#">Contacts</a>
                    </li>
                </ul>
                <div class="d-lg-flex col-lg-3 justify-content-lg-end">
                    <a class="btn btn-outline-dark br" role="button" href="<?php echo ($_SESSION['loggedin']) ? "../DashBoard/" : "../Login/"; ?>"><?php echo ($_SESSION['loggedin']) ? "Dashboard" : "Log In"; ?></a>
                </div>
            </div>
        </div>
    </nav>
