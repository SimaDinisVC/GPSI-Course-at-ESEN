        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse d-lg-flex" id="navbarsExample11">
                ...
                <div class="d-lg-flex col-lg-3 justify-content-lg-end">
                    <a class="btn btn-outline-primary br" role="button" href="<?php echo ($_SESSION['loggedin']) ? "../DashBoard/" : "../Login/" ?>"><?php echo ($_SESSION['loggedin']) ? "Dashboard" : "Login"; ?></a> 
                </div>
            </div>
        </div>
    </nav>
    <div class="container col-xl-10 px-4 py-5 mt-3">
